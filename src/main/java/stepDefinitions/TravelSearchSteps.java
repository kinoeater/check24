...
public class TravelSearchSteps extends DriverFactory {
    ...
    public void user_should_get_at_least_one_result() throws Throwable {
    ...
    public void user_is_presented_at_least_one_search_result() throws Throwable {
    	...
    	System.out.println("travel_count is "+travelPage.travel_number.getText());
...
//    	
//    	else {
//    		System.out.println("travel_count is "+travel_count);
//    	}
    }
